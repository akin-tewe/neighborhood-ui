...
import { XMarkIcon, ChevronDownIcon, MagnifyingGlassIcon } from '@heroicons/react/20/solid';
  ...
  return /* @__PURE__ */ jsx(
    "button",
    {
      ...
      children: loading ? /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx("span", { style: twinDotA }),
        /* @__PURE__ */ jsx("span", { style: twinDotB })
      ] }) : children
    }
  );
}
...
function Banner({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx(Icon, { style: { width: 24, height: 24, flexShrink: 0, color: "currentColor" } }),
        /* @__PURE__ */ jsxs("div", { style: { flex: 1, minWidth: 0, display: "flex", flexDirection: "column", gap: "var(--space-1)" }, children: [
          title && /* @__PURE__ */ jsx(
            "span",
            {
              style: {
        ...
        action && /* @__PURE__ */ jsx(Button, { variant: "ghost", size: "sm", onClick: action.onClick, style: buttonStyle, children: action.label }),
        dismissible && /* @__PURE__ */ jsx(Button, { variant: "ghost", size: "sm", iconOnly: true, onClick: handleDismiss, "aria-label": "Dismiss", style: buttonStyle, children: /* @__PURE__ */ jsx(XMarkIcon, { style: { width: 16, height: 16 } }) })
      ]
    }
  );
}
...
function ContentSection({
  ...
  return /* @__PURE__ */ jsxs("section", { style: { marginBottom: "var(--space-12)" }, children: [
        ...
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxs(
            "table",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { style: { background: "var(--neutral-50)" }, children: [
...
function FormSection({
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("div", { style: { marginBottom: "var(--space-6)" }, children: /* @__PURE__ */ jsx(Divider, {}) }),
...
function Input({
  ...
  const isSm = size === "sm";
  const icon = prefixIcon ?? (isSearch ? /* @__PURE__ */ jsx(MagnifyingGlassIcon, { style: { width: 16, height: 16 } }) : null);
  ...
  return /* @__PURE__ */ jsxs("div", { style: { animation: "nb-input-enter var(--duration-fast) var(--ease-spring) both" }, children: [
    label && /* @__PURE__ */ jsx(
      "label",
      {
        htmlFor: inputId,
    ...
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          icon && /* @__PURE__ */ jsx("span", { style: { color: "var(--neutral-400)", flexShrink: 0, display: "flex", alignItems: "center", fontSize: isSm ? "var(--text-sm)" : "var(--text-base)" }, children: icon }),
          /* @__PURE__ */ jsx(
            "input",
            {
              id: inputId,
...
function Menu({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { ref: triggerRef, style: { display: "inline-block" }, children: /* @__PURE__ */ jsx("div", { onClick: () => setOpen((v) => !v), children: trigger }) }),
        ...
        "div",
        {
          ...
          children: items.map((item, i) => {
            ...
            return /* @__PURE__ */ jsxs(React4.Fragment, { children: [
              ...
              item.dividerAfter && /* @__PURE__ */ jsx("div", { style: { margin: "var(--space-1) 0" }, children: /* @__PURE__ */ jsx(Divider, {}) })
            ] }, i);
          })
        }
      ),
...
function SegmentedControl({
  ...
  return /* @__PURE__ */ jsx("div", { className: "nb-segmented", style: wrapperStyle, children: options.map((option) => /* @__PURE__ */ jsx(
    "button",
    {
      type: "button",
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(
          "span",
          {
            ...
            children: /* @__PURE__ */ jsx(ChevronDownIcon, { style: { width: 16, height: 16 } })
          }
        )
      ]
    }
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "nb-setting-control", style: { flexShrink: 0 }, children: control })
      ]
    }
  );
}
function Tabs({
  ...
  return /* @__PURE__ */ jsx("div", { role: "tablist", style: { display: "flex", gap: "var(--space-1)" }, children: items.map((item) => {
...
function Tooltip({
  ...
  return /* @__PURE__ */ jsxs(
    "span",
    {
      ...
      children: [
        children,
        /* @__PURE__ */ jsx("span", { style: tooltipStyle, children: content })
      ]
    }
  );
}

export { Avatar, Badge, Banner, Button, Checkbox, ContentSection, DataTable, Divider, EmptyState, FormSection, Input, Menu, PropertyRow, SegmentedControl, Select, SettingRow, Tabs, Toggle, Tooltip };
